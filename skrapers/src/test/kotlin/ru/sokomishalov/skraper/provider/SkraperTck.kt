...
abstract class SkraperTck {
    ...
    protected val client: SkraperClient = SpringReactiveSkraperClient()
    ...
    protected fun assertMediaDownloaded(media: Media) = runBlocking {
        ...
        val downloaded = logAction { skraper.download(media = media, destDir = tmpDir, filename = UUID.randomUUID().toString()) }
